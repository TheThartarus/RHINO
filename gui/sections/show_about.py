...
def show_about(self):
    ...
    about_text = "Rhino 1.4.1\n\nDesarrollado por: Retroid Guy\n\n© 2025 Todos los derechos reservados"
    ...
    close_button = tk.Button(new_window, text="CERRAR", font=Style.button_font, bg=Style.button_bg, fg=Style.button_fg,
                             activebackground=Style.button_active_bg, activeforeground=Style.button_active_fg, command=new_window.destroy)
