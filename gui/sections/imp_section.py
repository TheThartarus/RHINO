...
def imp_section(self):
    ...
    documented_label = tk.Label(
        new_window,
        text="DOCUMENTADO",
        font=Style.label_font
    )
    documented_label.grid(
        row=1,
        column=0,
        pady=Style.pady,
        padx=Style.padx,
    ...
    name_entry['validatecommand'] = (
        name_entry.register(validate_name_input),
        '%P'
    )
    ...
    cdi_entry['validatecommand'] = (
        cdi_entry.register(validate_cdi_input),
        '%P'
    )
