...
class RhinoApp:
    def __init__(self, root):
        ...
        self.fisc_label = tk.Label(
            self.root,
            text="FISCALÍA",
            font=Style.label_font
        )
        self.fisc_label.grid(
            row=1,
            column=0,
            pady=Style.pady,
            padx=Style.padx,
        ...
        self.n_acusseds_label = tk.Label(
            self.root,
            text="N° DE IMPUTADOS",
            font=Style.label_font
        )
        self.n_acusseds_label.grid(
            row=2,
            column=0,
            pady=Style.pady,
            padx=Style.padx,
        ...
        self.n_acusseds_optionmenu.grid(
            row=2,
            column=1,
            pady=Style.pady,
            padx=Style.padx,
