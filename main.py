...
class RhinoApp:
    def __init__(self, root):
        ...
        self.trib_optionmenu = tk.OptionMenu(self.root, self.db.trib_var, "CONTROL 1", "CONTROL 2", "CONTROL 3", "CONTROL 4", "CONTROL 5")
        self.trib_optionmenu.grid(row=0, column=1, pady=Style.pady, padx=Style.padx, sticky="ew")

        # Desplegar el 'OptionMenu' de 'FISCALÍA'
        self.fisc_optionmenu = tk.OptionMenu(self.root, self.db.fisc_var, "FLAGRANCIA", "27°", "26°", "22°")
        ...
        self.n_acusseds_optionmenu = tk.OptionMenu(self.root, self.db.n_acusseds_var, "1", "2", "3", "4", "5", "6", "7", "8")
        ...
        self.accept_button = tk.Button(self.root, text="ACEPTAR", font=Style.button_font, bg=Style.button_bg, fg=Style.button_fg,
                                       activebackground=Style.button_active_bg, activeforeground=Style.button_active_fg, command=lambda: exp_data_fields(self, self.db))
        ...
        self.export_button = tk.Button(self.root, text="EXPORTAR", font=Style.button_font, bg=Style.button_bg, fg=Style.button_fg,
                                       activebackground=Style.button_active_bg, activeforeground=Style.button_active_fg, state=tk.DISABLED, command=lambda: export(self, self.db))
