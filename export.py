                            ...
                            if data.acusseds_data[0]["documented"] == "NO":
                                if data.acusseds_data[0]["gender"] == "F":
                                    if "IMP_NAMES" in run.text:
                                        run.text = run.text.replace(
                                            "IMP_NAMES",
                                            data.acusseds_data[0]["name"].strip().upper()
                                            + " (NO DOCUMENTADA)"
                                        )
                                else:
                                    if "IMP_NAMES" in run.text:
                                ...
                                if "IMP_CDIS" in run.text:
                                    run.text = run.text.replace(
                                        "IMP_CDIS", data.acusseds_data[0]['nationality'].strip().upper()
                                        + "-"
                                        + data.acusseds_data[0]["cdi"].strip().upper()
                                    )
                                if "RESPECTIVELY_TEXT" in run.text:
                                    run.text = run.text.replace(
                                        " RESPECTIVELY_TEXT",
                                ...
                                for idx in range(data.n_acusseds):
                                    if data.acusseds_data[idx]["documented"] == "NO":
                                        if data.acusseds_data[idx]["gender"] == "F":
                                            name_items.insert(
                                                0,
                                                data.acusseds_data[idx]["name"].strip().upper()
                                                + " (INDOCUMENTADA)"
                                            )
                                        else:
                                            name_items.insert(
                                ...
                                if "IMP_CDIS" in run.text:
                                    for idx in range(data.n_acusseds):
                                        if data.acusseds_data[idx]["documented"] == "NO":
                                            ...
                                            if "CARÁTULA" in file:
                                                run.text = run.text.replace(
                                                    "IMP_CDIS", data.acusseds_data[idx]['nationality'].strip().upper()
                                                    + "-"
                                                    + data.acusseds_data[idx]["cdi"].strip().upper()
                                                )
                                            else:
                                                run.text = run.text.replace(
                                                    "IMP_CDIS",
                                                    data.acusseds_data[idx]['nationality'].strip().upper()
                                                    + "-"
                                                    + data.acusseds_data[idx]["cdi"].strip().upper()
                                                    + ","
                                                )
                        ...
                        if "DECISIÓN" in current_patch:
                                ...
                                if idx is None:
                                    ...
                                    try:
                                        ...
                                        messagebox.showerror("Error", "No se pudo determinar el índice del imputado desde la ruta: "
                                                             + current_patch)
                                        sys.exit()
